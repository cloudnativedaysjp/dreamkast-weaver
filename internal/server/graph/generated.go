...
func (ec *executionContext) field_Query_viewerCount_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["confName"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("confName"))
		arg0, err = ec.unmarshalOConfName2ᚖdreamkastᚑweaverᚋinternalᚋgraphᚋmodelᚐConfName(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_voteCounts(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNVoteCount2ᚕᚖdreamkastᚑweaverᚋinternalᚋgraphᚋmodelᚐVoteCountᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) fieldContext_VoteCount_talkId(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "VoteCount",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) fieldContext_VoteCount_count(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "VoteCount",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) marshalNVoteCount2ᚕᚖdreamkastᚑweaverᚋinternalᚋgraphᚋmodelᚐVoteCountᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.VoteCount) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNVoteCount2ᚖdreamkastᚑweaverᚋinternalᚋgraphᚋmodelᚐVoteCount(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNVoteCount2ᚖdreamkastᚑweaverᚋinternalᚋgraphᚋmodelᚐVoteCount(ctx context.Context, sel ast.SelectionSet, v *model.VoteCount) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalOConfName2ᚖdreamkastᚑweaverᚋinternalᚋgraphᚋmodelᚐConfName(ctx context.Context, v interface{}) (*model.ConfName, error) {
	if v == nil {
		return nil, nil
	}
...
func (ec *executionContext) marshalOConfName2ᚖdreamkastᚑweaverᚋinternalᚋgraphᚋmodelᚐConfName(ctx context.Context, sel ast.SelectionSet, v *model.ConfName) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return v
